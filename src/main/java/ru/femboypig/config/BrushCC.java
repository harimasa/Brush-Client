    ...
    public static Screen configScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        // Armor Display
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("brushclient.combat.armordisplay"))
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("brushclient.combat.armordisplay"))
                                        .description(OptionDescription.of(Text.translatable("brushclient.combat.armordisplay.desc")))
                                        .binding(defaults.armorDisplay, () -> config.armorDisplay, newVal -> config.armorDisplay = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(int.class)
                                        .name(Text.translatable("brushclient.combat.armordisplay.top"))
                                        .description(OptionDescription.of(Text.translatable("brushclient.combat.armordisplay.desc")))
                                        .binding(100, () -> config.topArmor, newVal -> config.topArmor = newVal)
                                        .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                                                .range(0, 1080)
                                                .step(1))
                                        .build())
                                .option(Option.createBuilder(int.class)
                                        .name(Text.translatable("brushclient.combat.armordisplay.left"))
                                        .description(OptionDescription.of(Text.translatable("brushclient.combat.armordisplay.desc")))
                                        .binding(100, () -> config.leftArmor, newVal -> config.leftArmor = newVal)
                                        .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                                                .range(0, 1920)
                                                .step(1))
                                        .build())
